...
export default function DashboardPage() {
  ...
  // Sample course data
  const sampleCourses = [
    { id: 1, title: 'React Fundamentals', instructor: 'John Doe', students: 45, progress: 75, status: 'active', duration: '8 weeks', level: 'Beginner' },
    { id: 2, title: 'Advanced JavaScript', instructor: 'Jane Smith', students: 32, progress: 60, status: 'active', duration: '10 weeks', level: 'Advanced' },
    { id: 3, title: 'Node.js Backend', instructor: 'Mike Johnson', students: 28, progress: 90, status: 'completed', duration: '12 weeks', level: 'Intermediate' },
    { id: 4, title: 'Python for Data Science', instructor: 'Sarah Wilson', students: 67, progress: 0, status: 'upcoming', duration: '14 weeks', level: 'Beginner' },
  ];
  ...
  const renderMyCourses = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {sampleCourses.filter(course => course.status !== 'upcoming').map((course) => (
