        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="flex flex-col space-y-6 sm:space-y-8 order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-xl leading-relaxed">
              ...
              e-commerce, UX/UI design, and digital marketing. Learn from industry experts 
              and build real-world projects.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              <Button size="lg" className="h-12 sm:h-14 px-6 sm:px-8 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                Start Learning Free
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 pt-6 sm:pt-8">
              <div className="text-center sm:text-left">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">50K+</div>
                <div className="text-xs sm:text-sm text-gray-600 font-medium">Active Students</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-green-600 to-teal-600 bg-clip-text text-transparent">200+</div>
                <div className="text-xs sm:text-sm text-gray-600 font-medium">Expert Courses</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">4.9★</div>
                <div className="text-xs sm:text-sm text-gray-600 font-medium">Student Rating</div>
              </div>
            </div>

            {/* Trust indicators */}
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <span className="text-sm text-gray-500 font-medium">Trusted by learners at:</span>
            ...
            <div className="relative w-full max-w-lg lg:max-w-xl xl:max-w-2xl">
              ...
              <div className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 bg-white rounded-2xl shadow-xl p-4 sm:p-6 border border-gray-100 animate-bounce">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm sm:text-base font-bold text-gray-900">Course Completed!</div>
                    <div className="text-xs sm:text-sm text-gray-500">+500 XP Earned</div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-white rounded-2xl shadow-xl p-4 sm:p-6 border border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm sm:text-base font-bold text-gray-900">Learning Streak</div>
                    <div className="text-xs sm:text-sm text-gray-500">15 days strong! 🔥</div>
                  </div>
                </div>
              </div>
