...
export function AboutSection() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section
        id="about"
        className="bg-gradient-to-br from-gray-50 via-white to-orange-50 py-12 sm:py-16 lg:py-16"
      >
            ...
            <Card className="bg-orange-600 bg-gradient-to-r from-orange-600 to-red-700 border-0 shadow-2xl rounded-3xl overflow-hidden max-w-4xl mx-auto">
              <CardContent className="p-8 sm:p-12">
                ...
                <p className="text-orange-100 text-lg mb-8 max-w-2xl mx-auto drop-shadow-sm">
                  Join thousands of creators who have already started their
                  journey to success. Get access to proven strategies,
