          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-6 max-w-md">
                ...
                data science, UI/UX design, and more. Join 50,000+ learners advancing 
                their skills with AlphaAkki.
              </p>
              <div className="flex items-center space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-orange-500 rounded-lg flex items-center justify-center transition-colors duration-200">
